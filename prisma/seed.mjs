...
const postsSeed = [
  ...
  {
    title: "ব্লগ: চট্টগ্রাম বন্দরের দক্ষতা বাড়াতে প্রযুক্তি বিনিয়োগ কেন জরুরি",
    slug: "blog-chattogram-bondor-projukti-biniyog",
    location: "চট্টগ্রাম",
    categorySlug: "blog",
    section: "STANDARD",
    order: 9,
    excerpt: "দ্রুত কাস্টমস, স্মার্ট গেট ও ডেটা শেয়ারিং—বন্দর প্রতিযোগিতায় এগোতে করণীয়।",
    content:
      "বাংলাদেশের বাণিজ্য প্রবাহে চট্টগ্রাম বন্দর সবচেয়ে গুরুত্বপূর্ণ। কিন্তু বৈশ্বিক প্রতিযোগিতায় টিকে থাকতে হলে প্রযুক্তিতে ধারাবাহিক বিনিয়োগ অপরিহার্য।\n\nঅটোমেশন, ডেটা-চালিত সিদ্ধান্ত ও জনবল প্রশিক্ষণের সমন্বয় ঘটলে সময় ও ব্যয় কমবে—এটাই এই লেখার মূল বক্তব্য।",
    tags: ["ব্লগ", "বন্দর"],
  },
  {
    title: "ব্লগ: সিলেটের স্বাস্থ্যসেবায় বিকেন্দ্রীকরণ এখন সময়ের দাবি",
    slug: "blog-silet-shasthoshebay-bikendrikoron",
    location: "সিলেট",
    categorySlug: "blog",
    section: "STANDARD",
    order: 10,
    excerpt: "সব রোগীকে ঢাকামুখী না করে জেলা-উপজেলায় বিশেষায়িত সেবা বাড়াতে হবে।",
    content:
      "স্বাস্থ্যসেবার কেন্দ্রীয়করণ রোগী-স্বজনের ব্যয় ও কষ্ট বাড়ায়। জেলা পর্যায়ে বিশেষায়িত ইউনিট, টেলিমেডিসিন এবং রেফারাল প্রটোকল শক্তিশালী করা গেলে এই চাপ কমবে।\n\nসিলেটের উদাহরণ ধরে এই ব্লগে বিকেন্দ্রীকরণের বাস্তব দিকগুলো তুলে ধরা হয়েছে।",
    tags: ["ব্লগ", "স্বাস্থ্যনীতি"],
  },
];
